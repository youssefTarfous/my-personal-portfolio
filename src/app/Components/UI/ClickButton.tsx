...
const ClickButton: React.FC = () => {
  ...
  const onButtonClick = () => {
    ...
    // Create sparkle animation sequence
    ...
    // Create sparkle fade-out animation sequence
    ...
    // Create sparkle reset animation sequence
    ...
    // Run the animation sequences with proper types
    animate([
      ...sparklesReset,
